...
def get_CIFAR10_data(validation_ratio=0.02, flatten=False):
    ...
    """
    X_train, y_train, X_test, y_test = usgd.data.cifar10()
    ...
    plt.imshow(usgd.tensor_to_image(img))
    plt.axis('off')
    plt.show()
    ...
    # For random permumation, we can use torch.randperm or torch.randint
    # But, here, we use slicing instead.
